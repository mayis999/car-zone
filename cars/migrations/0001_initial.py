    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('AL', 'Alabama'), ('AK', 'Alaska'), ('AZ', 'Arizona'), ('AR', 'Arkansas'), ('CA', 'California'), ('CO', 'Colorado'), ('CT', 'Connecticut')], max_length=100)),
                ...
                ('car_photo_one', models.ImageField(blank=True, upload_to='photos/%Y/%m/%d')),
                ('car_photo_two', models.ImageField(blank=True, upload_to='photos/%Y/%m/%d')),
                ('car_photo_three', models.ImageField(blank=True, upload_to='photos/%Y/%m/%d')),
                ('car_photo_four', models.ImageField(blank=True, upload_to='photos/%Y/%m/%d')),
